...
1. **Grabas** tu episodio o video normalmente (Descript graba directo o importas el archivo).
2. **Descript transcribe** automáticamente (2-3 min para un clip de 10 min en el plan de pago).
3. **Pedís a Underlord**: *"Crea 3 clips de menos de 60 segundos con los momentos más impactantes"*.
4. Descript resalta fragmentos en la transcripción y genera previsualizaciones.
5. **Ajustás** los puntos de corte editando el texto — sin tocar la línea de tiempo.
6. Activas **captions automáticos**, elegís plantilla de subtítulos, ajustás fuente y color.
7. Exportás en formato vertical 9:16 para Shorts/Reels, directamente en 1080p (plan Creator en adelante).
